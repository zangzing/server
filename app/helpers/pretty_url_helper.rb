module PrettyUrlHelper
  ...
  # I added this method because the implementation from3.0.0 to
  # 3.0.9 changed and it now breaks the emails, when we figure out
  # how to deal with the new implementation of simple format we can
  # delete this.
  def zz_simple_format(text, html_options={}, options={})
        text = '' if text.nil?
