class SpreeZeroNineZero < ActiveRecord::Migration
  ...
  def self.up
    ...
    #  ZZ_HAS_PASSWORD_SALT_FOR_ AUTHLOGIC t.string   "salt",                      :limit => 128, :default => "", :null => false
    #  ZZ_NOT_NEEDED t.string   "remember_token"
    #  ZZ_NOT_NEEDED t.string   "remember_token_expires_at"
    #  t.datetime "created_at"
    #  t.datetime "updated_at"
    ...
    #  ZZ_CREATE_ALIAS_TO_USERNAME t.string   "login"
