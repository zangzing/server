...
describe "Flickr connector" do
  ...
  it "connects to Flickr, opens My Albums" do
    ui.wizard.add_photos_tab.at_home?.should be_true

    ui.wizard.add_photos_tab.click_folder "Flickr"
    ui.oauth_manager.login_to_flickr
  ...
  it "gives a name to the album" do
    ...
    @@album_name = "Flickr #{current_user[:stamp]}"
