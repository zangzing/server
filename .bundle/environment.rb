...
module Bundler
  ...
  SPECS        = [
        ...
        {:load_paths=>["/System/Library/Frameworks/Ruby.framework/Versions/1.8/usr/lib/ruby/gems/1.8/gems/rack-1.0.1/lib"], :loaded_from=>"/System/Library/Frameworks/Ruby.framework/Versions/1.8/usr/lib/ruby/gems/1.8/specifications/rack-1.0.1.gemspec", :name=>"rack"},
        {:load_paths=>["/System/Library/Frameworks/Ruby.framework/Versions/1.8/usr/lib/ruby/gems/1.8/gems/actionpack-2.3.5/lib"], :loaded_from=>"/System/Library/Frameworks/Ruby.framework/Versions/1.8/usr/lib/ruby/gems/1.8/specifications/actionpack-2.3.5.gemspec", :name=>"actionpack"},
        {:load_paths=>["/System/Library/Frameworks/Ruby.framework/Versions/1.8/usr/lib/ruby/gems/1.8/gems/actionmailer-2.3.5/lib"], :loaded_from=>"/System/Library/Frameworks/Ruby.framework/Versions/1.8/usr/lib/ruby/gems/1.8/specifications/actionmailer-2.3.5.gemspec", :name=>"actionmailer"},
        {:load_paths=>["/System/Library/Frameworks/Ruby.framework/Versions/1.8/usr/lib/ruby/gems/1.8/gems/activerecord-2.3.5/lib"], :loaded_from=>"/System/Library/Frameworks/Ruby.framework/Versions/1.8/usr/lib/ruby/gems/1.8/specifications/activerecord-2.3.5.gemspec", :name=>"activerecord"},
        {:load_paths=>["/System/Library/Frameworks/Ruby.framework/Versions/1.8/usr/lib/ruby/gems/1.8/gems/activeresource-2.3.5/lib"], :loaded_from=>"/System/Library/Frameworks/Ruby.framework/Versions/1.8/usr/lib/ruby/gems/1.8/specifications/activeresource-2.3.5.gemspec", :name=>"activeresource"},
        {:load_paths=>["/Library/Ruby/Gems/1.8/gems/authlogic-2.1.5/lib"], :loaded_from=>"/Library/Ruby/Gems/1.8/specifications/authlogic-2.1.5.gemspec", :name=>"authlogic"},
        ...
        {:load_paths=>["/Library/Ruby/Gems/1.8/gems/oauth-0.4.1/lib"], :loaded_from=>"/Library/Ruby/Gems/1.8/specifications/oauth-0.4.1.gemspec", :name=>"oauth"},
        {:load_paths=>["/Library/Ruby/Gems/1.8/gems/oauth-plugin-0.3.14/lib"], :loaded_from=>"/Library/Ruby/Gems/1.8/specifications/oauth-plugin-0.3.14.gemspec", :name=>"oauth-plugin"},
        ...
        {:load_paths=>["/System/Library/Frameworks/Ruby.framework/Versions/1.8/usr/lib/ruby/gems/1.8/gems/rails-2.3.5/lib"], :loaded_from=>"/System/Library/Frameworks/Ruby.framework/Versions/1.8/usr/lib/ruby/gems/1.8/specifications/rails-2.3.5.gemspec", :name=>"rails"},
        {:load_paths=>["/Users/mauricio/.bundle/ruby/1.8/gems/sqlite3-ruby-1.3.1/lib"], :loaded_from=>"/Users/mauricio/.bundle/ruby/1.8/specifications/sqlite3-ruby-1.3.1.gemspec", :name=>"sqlite3-ruby"},
