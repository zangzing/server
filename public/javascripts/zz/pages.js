...
//            $('div#share-body').load(zz.routes.path_prefix +'/shares/newpost', function(){
//                zz.wizard.resize_scroll_body();
//
//
//
...
//                        oauthmanager.login(zz.routes.path_prefix + '/facebook/sessions/new', function(){
...
//                        $(this).attr('checked', false);
//                        oauthmanager.login(zz.routes.path_prefix + '/twitter/sessions/new', function(){
...
//                        $.post(zz.routes.path_prefix + '/' + subject_type + 's/'+ subject_id +'/shares.json', serialized, function(data,status,request){
...
//        var self = this;
//        $('div#share-body').fadeOut('fast', function(){
//            $('div#share-body').load(zz.routes.path_prefix + '/shares/newemail', function(){
//
...
//                    submitHandler: function() {
//                        $.ajax({ type:     'POST',
//                            url:      zz.routes.path_prefix + '/'+ subject_type + 's/'+ subject_id +'/shares.json',
