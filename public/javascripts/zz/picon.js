    ...
    $.widget( "ui.zz_picon", {
        ...
        _create: function() {
            ...
            var caption = $('<div class="caption">'),
                    ...
                    cover_photo     = $('<img class="cover-photo" src="' + path_helpers.image_url('/images/photo_placeholder.png')+ '">'),
            ...
            if(o.coverUrl){
                var onload = function(image){
                    var scaledSize = image_utils.scale(image, {width:o.maxCoverWidth, height:o.maxCoverHeight});
                ...
                image_utils.pre_load_image(o.coverUrl, onload, onerror);
            }else{
                el.hover( mouse_in, mouse_out );
            }
        },
