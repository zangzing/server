...
zz.profile_pictures = {
    ...
    init_profile_pictures: function(elements) {
        _.each(elements, function(element) {
            ...
            if (profile_pic_url) {
                zz.image_utils.pre_load_image(profile_pic_url, function(image) {
                    var css = zz.image_utils.scale_center_and_crop(image, {width: profile_element.width(), height: profile_element.height()});
                    img_element.css(css);
