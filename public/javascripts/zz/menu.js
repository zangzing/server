            ...
            if (o.style == 'auto') {
                if (o.container != null) {
                    ...
                    if (menu_butt > container_butt) {
                        ...
                        //zz.logger.debug('Menu bottom:'+menu_butt+'> Container Bottom:'+container_butt+' then style is:'+self.computed_style);
                    } else {
                    ...
                    self.computed_style = 'dropdown';
                    //zz.logger.debug('Menu: container not defined, defaulting to dropdown' );
                }
            }
        ...
        open: function() {
            ...
            if (menu.is(':hidden') && el.not(':disabled')) {
                ...
                var mouse_in = function() {
                    //zz.logger.debug( 'menu mousein');
                    hover = true;
                }
                var mouse_out = function() {
                    //zz.logger.debug( 'menu mouseout');
                    hover = false;
                    setTimeout(function() {
                        if (!hover) {
                            self.close();
