...
(function(){
    ...
    function banner_html(){
        html = '<div class="invitation-banner">' +
                            '<div class="icon"></div>'+
                            '<div class="message ">' +
                                '<span class="bold">ZangZing will be closing on August 31st 2012.</span> Learn how to <a href="http://www.zangzing.com/blog">download your photos</a>.' +
                            '</div>' +
                       '</div>';
        //SUNSET
...
//		            '</div>';
	...
	function join_message(){
		...
		if(zz.invitation.invitername) {
			...
			name = name[0].substring(0,10);
			message = "<strong>" + name + "</strong> is using ZangZing. Join for free and follow " + name + ".";
		} else {
