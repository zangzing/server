...
(function(){
    ...
    var TWITTER_TEMPLATE = '<iframe allowtransparency="true" frameborder="0" scrolling="no" src="http://platform.twitter.com/widgets/tweet_button.html?count=horizontal&related=ZangZing&url={{url}}&counturl={{counturl}}&text={{text}}&related=ZangZing" style="width:130px; height:50px;"></iframe>'
